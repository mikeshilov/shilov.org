...
export default class NotesApp {
    process(req, context) {
        ...
        if (context) {
            if (context.itemIdToDelete) {
                ...
                const reqCommand = cmdOnSearchResults === null ? '' : ((_a = cmdOnSearchResults.groups['cmd']) !== null && _a !== void 0 ? _a : '').toLowerCase();
                if (context.selectedItem) {
                    ...
                    switch (reqCommand !== null && reqCommand !== void 0 ? reqCommand : '') {
                        case '':
        ...
        return (_b = this.updateNote(req)) !== null && _b !== void 0 ? _b : this.searchNotes(req);
    }
    updateNote(req, noteId) {
        ...
        if (match !== null) {
            ...
            const o = match.groups.o, e = match.groups.e ? match.groups.e : undefined, k = match.groups.k ? match.groups.k.trim() : undefined;
